...
int main(int argc, char **argv)
{
    ...
    rkdemo_init(&encoder_info_2);
    rkdemo_init(&decoder_info_2);
    ...
    printf("\ninit ENCODER INPUT:\n");
    rkdemo_init_input_buffer_all(&encoder_info_2, ZERO_COPY_API, RKNN_TENSOR_FLOAT16);
    printf("\ninit ENCODER OUTPUT:\n");
    rkdemo_init_output_buffer_all(&encoder_info_2, ZERO_COPY_API, 0);

    printf("\ninit DECODER INPUT:\n");
    rkdemo_init_input_buffer_all(&decoder_info_2, ZERO_COPY_API, RKNN_TENSOR_FLOAT16);
    printf("\ninit DECODER OUTPUT:\n");
    rkdemo_init_output_buffer_all(&decoder_info_2, ZERO_COPY_API, 0);

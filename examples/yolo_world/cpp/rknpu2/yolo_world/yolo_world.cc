...
int inference_yolo_world_model(rknn_app_context_t *app_ctx, image_buffer_t *img, float* text_input, int text_size, object_detect_result_list *od_results)
{
    int ret;
    ...
    inputs[1].size = text_size * sizeof(int32_t);
